...
- build(deps): bump pypdf from `6.14.2` to `6.16.1` to patch CVE-2026-71852 and CVE-2026-71870 (medium — excessive runtime/memory from large CID font width ranges and large `/ToUnicode` streams)
...
- build(deps): Bump @mui/material from `7.3.6` to `7.3.8` in `/frontend`
- build(deps): Bump @types/react from `19.2.7` to `19.2.14` in `/frontend`
...
[1.4.0]: https://github.com/NirKli/WattBot/compare/v1.3.0...v1.4.0
